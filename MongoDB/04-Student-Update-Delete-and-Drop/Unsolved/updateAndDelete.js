...
db.students.update({"name": "William"}, {$push:{"hobbies": "Extreme Basket Weaving"}})
...
db.students.update({"name": "Harry"}, {$set:{"operatorSys": "Mac"}})
...
db.students.update({"name":"Harry", {"operatorSys": "Mac"}})
...
db.students.update({"name": "William"}, {$set: {"gavecandy": true}})
