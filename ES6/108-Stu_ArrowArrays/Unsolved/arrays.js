...
const sum = princesses.reduce((sum, princess) => return sum + princess.age, 0);
const average = sum / princesses.length;
console.log("average age: ", average);

// BONUS: get the average age of all princesses whose name includes an 'l'
const lNames = princesses.filter(princess => return princess.name.includes("l"));

const lSum = lNames.reduce((sum, princess) => return sum + princess.age, 0);
